...
const COUNTRY_ALIAS_OVERRIDES = {
  ...
  GB: ["Royaume-Uni", "Royaume Uni", "Great Britain", "Britain", "UK", "British"],
  RU: ["Russie", "Russian", "Russe"],
  ...
  IL: ["Israel", "Israël", "Israeli", "Israelis", "Israelien", "Israelienne", "Israeliens"],
  ...
  KR: ["Corée du Sud", "Coree du Sud", "South Korea", "Republic of Korea", "Korean", "South Korean"],
  KP: ["Corée du Nord", "Coree du Nord", "North Korea", "DPRK", "North Korean"],
  SY: ["Syrie", "Syrian", "Syrien", "Syrienne"],
  IQ: ["Irak", "Iraqi", "Irakien", "Irakienne"],
  YE: ["Yemen", "Yémen", "Yemeni", "Yemenite"],
  OM: ["Oman", "Sultanate of Oman", "Omani", "Omanais", "Omanaise"],
  JO: ["Jordan", "Jordanie", "Jordanian", "Jordanien", "Jordanienne"],
  LB: ["Lebanon", "Liban", "Lebanese", "Libanais", "Libanaise"],
  FR: ["France", "French", "Français", "Francais"],
  TR: ["Turkey", "Turquie", "Turkish", "Turc", "Turque"],
  SA: ["Saudi Arabia", "Arabie saoudite", "Saudi", "Saoudien", "Saoudienne"]
};
